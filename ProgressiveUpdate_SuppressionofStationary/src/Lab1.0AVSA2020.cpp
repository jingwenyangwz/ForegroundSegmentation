...
// if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "/home/peter/eclipse-workspace/Ex1_LoadModifySave/dataset2012lite";
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			double alpha = 0.4; // to set ... //Lab1.1.2-3
			bool selective_bkg_update = true; // true ... //Lab1.1.2-3
			int threshold_ghosts2 = 10; // to set ... //Lab1.1.3
			bool rgb = false; //true;
			...
			fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, threshold_ghosts2, rgb);
