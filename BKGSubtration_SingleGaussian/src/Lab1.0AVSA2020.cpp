...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			int threshold_ghosts2=20; // to set ... //Lab1.1.3
			bool rgb = false; //true;

			double alpha_gaussian = 0.04;
			float var = 10;
			...
			fgseg::bgs avsa_bgs(tau, alpha, threshold_ghosts2, rgb, alpha_gaussian,var);			// END - TO CHANGE FOR DIFF PROJECTS
			...
			for (;;) {
		        ...
		        //...
           		...
           		avsa_bgs.UnimodalupdateBackground(img);
