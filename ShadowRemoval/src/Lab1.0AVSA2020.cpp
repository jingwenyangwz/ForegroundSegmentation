...
int main(int argc, char ** argv)
{
	...
	string dataset_path = "/home/peter/eclipse-workspace/Ex1_LoadModifySave/shadow";
	//string dataset_path = "/home/peter/eclipse-workspace/Ex1_LoadModifySave/dataset2012lite/dataset";
	...
	string dataset_cat[1] = {"shadow"};
	string baseline_seq[6] = {"bungalows", "backdoor", "busStation", "copyMachine", "cubicle", "peopleInShade"};
...
//	string dataset_path = "/home/peter/eclipse-workspace/Ex1_LoadModifySave/AVSASlidesVideos_dataset";
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "/home/peter/eclipse-workspace/Ex1_LoadModifySave";
//	string project_root_path = "/home/peter/eclipse-workspace/Ex1_LoadModifySave/AVSASlidesVideos_dataset/Results";

//	string project_name = "Lab1.0AVSA2020"; // project exe name
	string project_name = "dataset2012lite";
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			//double alpha=0.04; // to set ... //Lab1.1.2-3
			...
			//fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, rgb);
			//fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, threshold_ghosts2, rgb); //construct object of the bgs class
			fgseg::bgs avsa_bgs(tau, alpha, beta, selective_bkg_update, rgb, sTh, dTh);
