...
int main(int argc, char ** argv)
{
	...
	string dataset_path = "/home/avsa/avss/Lab1.0AVSA2020_5/AVSASlidesVideos_dataset";
	...
	string project_root_path = "/home/avsa/avss/AVSA2020results";
	...
	for (int c = 0; c<NumCat; c++)
	{
		...
		for (int s = 0; s<NumSeq; s++)
		{
			...
			float var = 30;
			float weight_threshold = 0.9;

			//construct object of the bgs class
			fgseg::bgs avsa_bgs(tau, alpha, rgb, k, alpha_gaussian, var, weight_threshold);
			...
			for (;;) {
				...
				avsa_bgs.GMMupdateBackground(img);
